...
const connectToRedux = connect(
  createStructuredSelector({
    errorMessage: editArticleErrorMessageSelector,
    successMessage: editArticleDataSelector,
    currentUser: getCurrentUserDataSelector,
    initialValues: getArticleDataSelector
  }),
  dispatch => ({
    resetData: () => {
            ...
            <div className="main main-raised main-product">
              <div className="row">
                <div className="col-md-12 col-sm-12">
                  <h2 className="title text-center"> Edit your article </h2>
                  {successMessage ? (
